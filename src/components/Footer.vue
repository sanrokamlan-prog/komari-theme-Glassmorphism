  ...
  <footer class="w-full max-w-[1280px] mx-auto p-4">
    <div class="flex w-full flex-row justify-between gap-4 text-xs text-muted-foreground">
      ...
      <div class="flex flex-wrap gap-1 items-center justify-end text-right">
        ...
        >
          <a
            href="https://github.com/xueyeshengdan/komari-theme-Glassmorphism" target="_blank" rel="noopener noreferrer"
            class="transition-opacity hover:opacity-80"
          >
            <span class="font-medium text-foreground">Komari Glassmorphism Lobster Edition</span>
          </a>
        </DataTooltip>
      </div>
    </div>
